            ...
            <div className="bg-gradient-to-br from-primary to-primary/80 rounded-3xl p-8 sm:p-10 text-background shadow-2xl">
              ...
              <div className="grid grid-cols-2 gap-8">
                <div className="text-center group">
                  <div className="text-4xl sm:text-5xl font-bold mb-3 group-hover:scale-110 transition-transform">718</div>
                  <div className="text-sm sm:text-base opacity-90 leading-tight">Students directly supported in 2025</div>
                </div>
                <div className="text-center group">
                  <div className="text-4xl sm:text-5xl font-bold mb-3 group-hover:scale-110 transition-transform">5,500+</div>
                  <div className="text-sm sm:text-base opacity-90 leading-tight">Sanitary pads distributed</div>
                </div>
                <div className="text-center group">
                  <div className="text-4xl sm:text-5xl font-bold mb-3 group-hover:scale-110 transition-transform">40+</div>
                  <div className="text-sm sm:text-base opacity-90 leading-tight">Winter jerseys provided</div>
                </div>
                <div className="text-center group">
                  <div className="text-4xl sm:text-5xl font-bold mb-3 group-hover:scale-110 transition-transform">1</div>
